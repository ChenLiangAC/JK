        ...
        <div class="log">
            ...
            <div class="rightarea">
                ...
                <div class="inputinner">
                    <form class="form-horizontal" action="regcheck.php" method="post">
                       ...
                       <div class="form-group">
                            <div class="col-sm-10">
                                <input type="password" class="form-control" id="inputPassword3" placeholder="确认密码/Password Confirm" name="confirm">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button type="sumbit" class="btn btn-danger" name="Submit" value="注册/SignUp">注册/SignUp</button>
